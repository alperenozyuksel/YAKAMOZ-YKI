...
"    KİLİTLENME SÜRESİ:"))
    ...
    def ARMED_butonu(self):
        ...
        iha1.baglanti.armed = True

    def DISARMED_butonu(self):

        iha1.baglanti.disarm = True

    def FBWA_butonu(self):
        iha1.baglanti.mode = VehicleMode("FBWA")

    def FBWB_butonu(self):
        iha1.baglanti.mode = VehicleMode("FBWB")

    def RTL_butonu(self):

        iha1.baglanti.mode = VehicleMode("RTL")

    def MANUEL_butonu(self):
        iha1.baglanti.mode = VehicleMode("MANUEL")

    def AUTO_butonu(self):
        iha1.baglanti.mode = VehicleMode("AUTO")
